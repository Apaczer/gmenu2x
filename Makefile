...
CHAINPREFIX := /opt/trimui
CROSS_COMPILE := /opt/trimui/bin/arm-none-linux-gnueabi-
...
CFLAGS = -ggdb -DTARGET_TRIMUI -DTARGET=$(TARGET) -D__BUILDTIME__="$(BUILDTIME)" -DLOG_LEVEL=3 $(SDL_CFLAGS) -I$(CHAINPREFIX)/usr/include/ -I$(SYSROOT)/usr/include/  -I$(SYSROOT)/usr/include/SDL/ -std=c++11
#CFLAGS += -fdata-sections -ffunction-sections -fno-exceptions -fno-math-errno -fno-threadsafe-statics -Os
